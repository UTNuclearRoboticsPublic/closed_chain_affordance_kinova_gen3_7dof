"""ROS 2 launch script to launch the CCA planner for the tasks defined in src/cca_kinova_gen3_7dof_node.cpp

Author: Crasun Jans

This script launches the CCA planner for the tasks defined in src/cca_kinova_gen3_7dof_node.cpp by loading the node with
...
### Usage:
    ...
    ros2 launch cca_kinova_gen3_7dof cca_kinova_gen3_7dof.launch.py debug:=true
====================================================================
